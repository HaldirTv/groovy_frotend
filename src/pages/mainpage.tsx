...
export const Main = () => {
    ...
    const tracks = [
    { title: "Track", author: "Author", genre: "Genre", cover: Cover }
    ];
    return (
<div className='Main'>
                ...
                <div className='MainHeader'>
                    ...
                    <div className='UserCont'>
                        ...
                        <div className='profileCont'>
                            ...
                            <button className='ButtonProfile' onClick={() => navigate('/profile')}>
                                {profileName}
                            </button>
                        </div>
                    </div>
                ...
                <div className='Main2'>
                    ...
                    <div className='MusicCardCont'>
                        ...
                        <div className='ContMusicCardText'>
                            ...
                            <span className='AuthorText'>{track.author}</span>
                            <span className='StyleTrack'>{track.genre}</span>
                        </div>
                        </div>
                        ))}
                    </div>
                ...
                <div className='FooterPlayer'>
                    ...
                    <div className='Volume'>
                        <button className='ButtonIcon'>
                            <img src={Button} className='ButtonIcon' />
                        </button>
